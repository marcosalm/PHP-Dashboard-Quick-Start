...
class MY_Model extends CI_Model
{
    ...
    public function get($primary_value)
    {
        ...
        $row = $this->db->where(singular($this->_table).'_'.$this->primary_key, $primary_value)
                        ->get($this->_table)
                        ->{$this->_return_type()}();
        $this->_temporary_return_type = $this->return_type;
    ...
    public function get_many($values)
    {
        ...
        $this->db->where_in(singular($this->_table).'_'.$this->primary_key, $values);
    ...
    public function update($primary_value, $data, $skip_validation = FALSE)
    {
        ...
        if ($valid)
        {
            $result = $this->db->where(singular($this->_table).'_'.$this->primary_key, $primary_value)
                               ->set($data)
                               ->update($this->_table);
    ...
    public function update_many($primary_values, $data, $skip_validation = FALSE)
    {
        ...
        if ($valid)
        {
            $result = $this->db->where_in(singular($this->_table).'_'.$this->primary_key, $primary_values)
                               ->set($data)
                               ->update($this->_table);
    ...
    public function delete($id)
    {
        ...
        $this->db->where(singular($this->_table).'_'.$this->primary_key, $id);

        if ($this->soft_delete)
        {
            $result = $this->db->update($this->_table, array( $this->soft_delete_key => date('Y-m-d H:i:s') ));
        }
        else
        {
    ...
    public function delete_many($primary_values)
    {
        ...
        $this->db->where_in(singular($this->_table).'_'.$this->primary_key, $primary_values);
	...
	/**
     * A wrapper to $this->db->created_after()
     */
